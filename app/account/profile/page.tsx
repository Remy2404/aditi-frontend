...
export default function ProfilePage() {
  ...
  if (authLoading || loading) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-linear-to-br from-gray-50 to-blue-50">
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-blue-50 to-indigo-50 py-8">
      <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex items-center justify-between">
            ...
            {!isEditing && (
              <button
                ...
                className="flex items-center gap-2 bg-linear-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
        ...
        {/* Alert Messages */}
        {error && (
          <div className="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-lg shadow-sm animate-in fade-in slide-in-from-top-2">
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-50 border-l-4 border-green-500 rounded-lg shadow-sm animate-in fade-in slide-in-from-top-2">
            <div className="flex items-center gap-3">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-linear-to-r from-blue-600 to-indigo-600 px-8 py-10 -mx-6 -mt-6 mb-8">
              <div className="flex items-center gap-6">
                <div className="relative">
                  <div className="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-xl ring-4 ring-white/20">
                    <span className="text-5xl font-bold bg-linear-to-br from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                      {formData.name
                  ...
                  {isEditing && (
                    <button
                      type="button"
                      className="absolute bottom-0 right-0 w-9 h-9 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50 transition-colors border-2 border-blue-600"
                    >
                      <svg
            ...
            <div className="px-8 pb-8 space-y-8">
                ...
                <div className="border-t border-gray-200 pt-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-linear-to-br from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-100">
                      ...
                      <p className="text-gray-900 font-mono text-xs break-all bg-white px-3 py-2 rounded-lg border border-blue-200">
                        {profile.uid}
                      </p>
                    </div>
              ...
              {isEditing && (
                <div className="flex justify-end gap-4 pt-8 border-t border-gray-200">
                  ...
                  <button
                    type="submit"
                    className="flex items-center gap-2 px-8 py-3 bg-linear-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transform hover:-translate-y-0.5"
                    disabled={saving}
                  >
                    {saving ? (
                      <>
