...
import { Search, ShoppingCart, Heart, Menu, LogOut, User, Package, Settings } from "lucide-react"
      ...
      <div className="bg-gray-900 text-white text-center py-2 text-sm">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link href="/help" className="hover:text-gray-300 transition-colors">Help & FAQs</Link>
            <Link href={user ? "/account" : "/login"} className="hover:text-gray-300 transition-colors">
              My Account
            </Link>
          ...
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="flex items-center gap-12">
              <Link href="/" className="flex items-center group">
                <img src="/logo.png" alt="COZA STORE" className="h-10 w-20 transition-transform group-hover:scale-105" />
              </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Link href="/cart">
                ...
                <Badge className="absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center p-0 bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg text-xs font-bold group-hover:scale-110 transition-transform">
                  2
                </Badge>
              </Link>
            </Button>
            ...
            >
              <Link href="/account/wishlist">
                ...
                <Badge className="absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center p-0 bg-gradient-to-r from-red-500 to-red-600 text-white shadow-lg text-xs font-bold group-hover:scale-110 transition-transform">
                  1
                </Badge>
              </Link>
            </Button>
            ...
            {loading ? (
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="relative h-10 w-10 rounded-full p-0 hover:ring-2 hover:ring-blue-300 hover:shadow-lg transition-all">
                ...
                <DropdownMenuContent className="w-72 shadow-xl border-slate-200" align="end" forceMount>
                  {user ? (
                    <>
                      <DropdownMenuLabel className="font-normal p-4 bg-gradient-to-br from-blue-50 to-purple-50 rounded-t-lg">
                      ...
                      <div className="p-2">
                        {ACCOUNT_MENU.map((item) => (
                          <DropdownMenuItem
                            key={item.href}
                            asChild
                            className="cursor-pointer rounded-lg p-3 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all group"
                          >
                            <Link href={item.href} className="flex items-center">
                              <div className="mr-3 flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-blue-100 to-purple-100 group-hover:from-blue-200 group-hover:to-purple-200 transition-all group-hover:scale-110">
                                <item.icon className="h-4 w-4 text-blue-700" />
                              </div>
                              <div className="flex flex-col">
                                <span className="text-sm font-semibold text-slate-900 group-hover:text-blue-700 transition-colors">{item.label}</span>
                              </div>
                            </Link>
                          </DropdownMenuItem>
                        ))}
                    ...
                    <>
                      <DropdownMenuLabel className="font-normal p-4 bg-gradient-to-br from-blue-50 to-purple-50 rounded-t-lg">
                        <div className="text-center">
                          <p className="text-lg font-bold text-slate-900 mb-1">Welcome!</p>
                      ...
                      <div className="p-2 space-y-2">
                        <DropdownMenuItem asChild className="cursor-pointer rounded-lg p-0 focus:bg-transparent">
                          <Link href="/login" className="flex items-center justify-center w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 rounded-lg shadow-lg hover:shadow-xl transition-all">
                            Sign In
                          </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild className="cursor-pointer rounded-lg p-0 focus:bg-transparent">
                          <Link href="/register" className="flex items-center justify-center w-full bg-white hover:bg-slate-50 text-slate-700 font-semibold py-3 rounded-lg border-2 border-slate-300 hover:border-slate-400 transition-all">
                            Create Account
                          </Link>
                        </DropdownMenuItem>
                      </div>
                      <DropdownMenuSeparator />
                      <div className="p-2">
                        <DropdownMenuItem asChild className="cursor-pointer rounded-lg p-3 hover:bg-slate-50 transition-all">
                          <Link href="/account/orders" className="flex items-center">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-xs text-slate-500">Check order status</span>
                            </div>
                          </Link>
                        </DropdownMenuItem>
                      </div>
              ...
              <SheetContent side="left" className="w-[300px] sm:w-[400px]">
                <SheetHeader>
                  <SheetTitle className="text-left text-2xl font-bold">
                    COZA <span className="font-light text-slate-500">STORE</span>
                  </SheetTitle>
                </SheetHeader>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  {user ? (
                    ...
                    <Button asChild className="mt-2 w-full h-11 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700">
